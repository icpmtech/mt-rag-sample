...
const Chat = () => {
    ...
    const { setClearChatFunction, setOpenSettingsFunction, setIsLoading: setChatIsLoading, setHasQuestions } = useChatContext();
    ...
    // Update hasQuestions state in context
    useEffect(() => {
        setHasQuestions(!!lastQuestionRef.current);
    }, [lastQuestionRef.current, setHasQuestions]);
