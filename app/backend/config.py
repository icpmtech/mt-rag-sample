...
CONFIG_SHAREPOINT_APPROACH = "sharepoint_approach"
CONFIG_SHAREPOINT_SEARCH_CLIENT = "sharepoint_search_client"
CONFIG_SHAREPOINT_GRAPH_HELPER = "sharepoint_graph_helper"
CONFIG_FEDERATED_SEARCH_ENABLED = "federated_search_enabled"
